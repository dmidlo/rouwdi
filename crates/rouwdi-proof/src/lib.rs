...
pub struct ArtifactManifestEntry {
    ...
    pub linker_payload_sha256: String,
    pub compile_unit_id: String,
    pub mir_hash: String,
    pub mir_source_hash: String,
    pub mono_graph_hash: String,
    pub mono_source_hash: String,
    pub codegen_source_hash: String,
    ...
    pub codegen_input_source: Option<String>,
